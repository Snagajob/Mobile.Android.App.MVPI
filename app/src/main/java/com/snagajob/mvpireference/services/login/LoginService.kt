...
class LoginService(retrofit: Retrofit) {
     ...
     * More research is needed on whether we need to store that disposable anywhere temporarily. We could be
     * temporarily leaking the service until the call completes in some cases.
     */
     ...
     * are no long running streams when a request is made. It also allows us to
     * continue making requests after an exception occurs within the stream.
     */
    interface Login {
